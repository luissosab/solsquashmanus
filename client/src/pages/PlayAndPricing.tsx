...
import { PLAYBYPOINT_SOL_JUNIOR_URL } from "@/lib/booking";
import { Link } from "wouter";

const waysToPlay = [
  { name: "Book a Court", short: "Your court, your hour.", long: "Your court, your hour. Play with a friend, another Sol player or rotate with a group of three.", detail: "MAKE A RALLY YOUR OWN", action: "BOOK A COURT" },
  { name: "Open Play", short: "Our social squash mixer.", long: "Our social squash mixer. Three hours of games, court rotations and players matched by level.", detail: "MEET YOUR NEXT RALLY PARTNER", action: "FIND OPEN PLAY" },
  { name: "Coached Sessions", short: "Train in a small group with Bruna or Vini.", long: "Train in a small group with Bruna or Vini — Drills & Matches, Clinics and Women Play.", detail: "LEARN, PLAY, REPEAT", action: "SEE COACHED SESSIONS" },
  { name: "Private Lessons", short: "Your game. Our full attention.", long: "Your game. Our full attention. One-on-one with Bruna or Vini.", detail: "ONE-ON-ONE ON COURT", action: "BOOK A PRIVATE LESSON" },
];
