...
export default function PlayAndPricing() {
  ...
  return (
    <>
      <section className="play-hero play-hero--mural"><div><p className="eyebrow eyebrow--cyan">WAYS TO PLAY</p><h1>PICK YOUR<br />WAY <em>IN.</em></h1><p>Court bookings, open play, coached sessions and lessons. With or without a membership.</p></div><figure className="play-hero__mural"><img src="/manus-storage/sol-facility-blue-court_a3f6989d.png" alt="The blue squash court at Sol" /></figure></section>
