  ...
  return (
    <>
      <section className="home-hero home-hero--real">
        <div className="home-hero__video-frame" aria-hidden="true">
          <video
        ...
        <div className="home-hero__copy">
          ...
          >
            645 NW 72ND STREET · LITTLE RIVER
          </motion.p>
      ...
      >
        <img
          className="mural-sun mural-sun--home-paths"
          src="/media/sol-sun-repaired-orange_e644a385.png"
          alt=""
          aria-hidden="true"
        />
        <div className="home-paths__intro">
          <p className="eyebrow eyebrow--cyan">FIND YOUR WAY IN</p>
        ...
        <div className="home-paths__list">
          <Link href="/play" className="home-path-card home-path-card--play">
            ...
            <b>
              EXPLORE PLAY <i aria-hidden="true">↗</i>
            </b>
          </Link>
          <Link
            href="/new-to-squash"
            className="home-path-card home-path-card--new"
          >
            <span>02</span>
            <strong>NEW TO SQUASH</strong>
            <p>No experience needed. Rackets provided. Come ready to move.</p>
            <b>
              START HERE <i aria-hidden="true">↗</i>
            </b>
          </Link>
          <Link
            href="/schedule"
      ...
      <section
        className="club-intro club-intro--real club-intro--lifestyle"
        aria-labelledby="club-intro-title"
      >
        <span className="squash-ball squash-ball--home-club" aria-hidden="true">
          <i />
          <i />
        </span>
        <div className="club-intro__section-intro">
          <h2 id="club-intro-title">THE CLUB</h2>
          <p className="club-intro__promise">
            Come for the squash. Stay for everything around it.
          </p>
        </div>
        <div className="club-intro__modules">
          <article className="club-intro__module club-intro__module--squash">
            <figure>
              <img
                src={assets.court}
                alt="One of Sol Squash's full-glass courts"
              />
            </figure>
            <div className="club-intro__club-card">
              <h3>SQUASH</h3>
              <strong>5 Full-glass courts</strong>
              <p>
                Book a court, join a session or train with us. All levels
                welcome.
              </p>
            </div>
          </article>
          <article className="club-intro__module club-intro__module--recover">
            <figure>
              <img src={assets.sauna} alt="The sauna at Sol Squash" />
            </figure>
            <div className="club-intro__club-card">
              <h3>RECOVER &amp; TRAIN</h3>
              <strong>Sauna, cold plunge, showers and gym</strong>
              <p>
                Get your sweat in, reset and leave feeling better than you came.
              </p>
            </div>
          </article>
          <article className="club-intro__module club-intro__module--stay">
            <figure>
              <img
                src={assets.clubFacility}
                alt="The café, lounge, workspace and glass-court facilities at Sol Squash"
              />
            </figure>
            <div className="club-intro__club-card">
              <h3>STAY &amp; CONNECT</h3>
              <strong>Café, lounge and workspace</strong>
              <p>
                Grab a drink, get some work done or hang around after your
                match. Sol is a club you actually want to stay in.
              </p>
            </div>
          </article>
        </div>
      ...
      <section className="mural-feature">
        <div className="mural-feature__copy">
          ...
          <p>MORE THAN A GAME, A WAY OF LIFE.</p>
          <Link href="/play" className="text-link">
            PICK YOUR WAY IN <span>↗</span>
          </Link>
        </div>
        <figure className="mural-feature__image">
          <img
            src={assets.mural}
            alt="The Sol Squash front mural with squash-ball graphics and the club sun-face"
          />
        </figure>
      </section>
    </>
